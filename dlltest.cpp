...
void FIPS140_SampleApplication()
{
	...
	// encrypt and decrypt
	const CryptoPP::byte key[] = {0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef, 0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef, 0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef};
	const CryptoPP::byte iv[] = {0x12,0x34,0x56,0x78,0x90,0xab,0xcd,0xef};
	const CryptoPP::byte plaintext[] = {	// "Now is the time for all " without tailing 0
		0x4e,0x6f,0x77,0x20,0x69,0x73,0x20,0x74,
		0x68,0x65,0x20,0x74,0x69,0x6d,0x65,0x20,
		0x66,0x6f,0x72,0x20,0x61,0x6c,0x6c,0x20};
	CryptoPP::byte ciphertext[24];
	CryptoPP::byte decrypted[24];
	...
	// hash
	const CryptoPP::byte message[] = {'a', 'b', 'c'};
	const CryptoPP::byte expectedDigest[] = {0xA9,0x99,0x3E,0x36,0x47,0x06,0x81,0x6A,0xBA,0x3E,0x25,0x71,0x78,0x50,0xC2,0x6C,0x9C,0xD0,0xD8,0x9D};
	CryptoPP::byte digest[20];
