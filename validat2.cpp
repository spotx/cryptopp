...
bool SignatureValidate(PK_Signer &priv, PK_Verifier &pub, bool thorough = false)
{
	...
	const CryptoPP::byte *message = (CryptoPP::byte *)"test message";
...
bool ValidateRSA()
{
	...
	CryptoPP::byte out[100], outPlain[100];
	bool pass = true, fail;

	{
		const char *plain = "Everyone gets Friday off.";
		static const CryptoPP::byte signature[] =
		...
		size_t signatureLength = rsaPriv.SignMessage(GlobalRNG(), (CryptoPP::byte *)plain, strlen(plain), out);
		...
		fail = !rsaPub.VerifyMessage((CryptoPP::byte *)plain, strlen(plain), out, signatureLength);
		pass = pass && !fail;
	...
	{
		CryptoPP::byte *plain = (CryptoPP::byte *)
			"\x54\x85\x9b\x34\x2c\x49\xea\x2a";
		static const CryptoPP::byte encrypted[] =
			"\x14\xbd\xdd\x28\xc9\x83\x35\x19\x23\x80\xe8\xe5\x49\xb1\x58\x2a"
			"\x8b\x40\xb4\x48\x6d\x03\xa6\xa5\x31\x1f\x1f\xd5\xf0\xa1\x80\xe4"
			"\x17\x53\x03\x29\xa9\x34\x90\x74\xb1\x52\x13\x54\x29\x08\x24\x52"
			"\x62\x51";
		static const CryptoPP::byte oaepSeed[] =
...
bool TestPolynomialMod2()
{
	...
	for (unsigned int i=start; i < stop; i++)
	{
		...
		prng.GenerateBlock((CryptoPP::byte*)&w, sizeof(w));
...
bool ValidateECDSA()
{
	...
	GF2NT gf2n(191, 9, 0);
	CryptoPP::byte a[]="\x28\x66\x53\x7B\x67\x67\x52\x63\x6A\x68\xF5\x65\x54\xE1\x26\x40\x27\x6B\x64\x9E\xF7\x52\x62\x67";
	CryptoPP::byte b[]="\x2E\x45\xEF\x57\x1F\x00\x78\x6F\x67\xB0\x08\x1B\x94\x95\xA3\xD9\x54\x62\xF5\xDE\x0A\xA1\x85\xEC";
	EC2N ec(gf2n, PolynomialMod2(a,24), PolynomialMod2(b,24));

	EC2N::Point P;
	ec.DecodePoint(P, (CryptoPP::byte *)"\x04\x36\xB3\xDA\xF8\xA2\x32\x06\xF9\xC4\xF2\x99\xD7\xB2\x1A\x9C\x36\x91\x37\xF2\xC8\x4A\xE1\xAA\x0D"
	...
	static const CryptoPP::byte sig[]="\x03\x8e\x5a\x11\xfb\x55\xe4\xc6\x54\x71\xdc\xd4\x99\x84\x52\xb1\xe0\x2d\x8a\xf7\x09\x9b\xb9\x30"
	...
	fail = !pub.VerifyMessage((CryptoPP::byte *)"abc", 3, sig, sizeof(sig));
	pass = pass && !fail;

	cout << (fail ? "FAILED    " : "passed    ");
	cout << "verification check against test vector\n";

	fail = pub.VerifyMessage((CryptoPP::byte *)"xyz", 3, sig, sizeof(sig));
	pass = pass && !fail;
...
bool ValidateESIGN()
{
	...
	fail = !verifier.VerifyMessage((CryptoPP::byte *)plain, strlen(plain), signature, verifier.SignatureLength());
	pass = pass && !fail;
	...
	signer.AccessKey().GenerateRandom(GlobalRNG(), MakeParameters("Seed", ConstByteArrayParameter((const CryptoPP::byte *)"test", 4))("KeySize", 3*512));
	verifier = signer;
